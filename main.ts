...
game.onUpdateInterval(5000, function () {
    sprites.create(img`
        ...
        . . . . f f f . . . . f f f . . 
        `, SpriteKind.Enemy).setPosition(145, 99)
    sprites.create(img`
        . . . . . . . e e e e e . . . . 
        . . . . . e e 2 2 2 2 2 e . . . 
        . . . . e e 2 2 2 2 2 2 2 e . . 
        ...
        . e e f c b b f e e f c b b f . 
        . . . . f f f . . . . f f f . . 
        `, SpriteKind.Enemy).setVelocity(39, 0)
})
game.onUpdateInterval(2000, function () {
    sprites.create(img`
        ...
        . d 6 6 9 c b f f f f f f f 6 c 
        . 6 6 6 9 b f f b b b f b b f 6 
        . 6 6 6 6 6 f b b b b f b b b f 
        . 6 6 6 6 f 6 6 6 6 6 f 6 6 6 f 
        . 6 d d 6 8 f 8 8 8 f 8 f 8 f f 
        . d d 6 8 8 8 f 8 8 f 8 f 8 f 8 
        . 8 8 8 8 8 8 8 f f f 8 8 f 8 8 
        . 8 8 8 8 f f f 8 8 8 8 f f f f 
        . . . 8 f f 2 f f 8 8 f f 2 f f 
        . . . . f f f f . . . . f f f . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy).setVelocity(27, 0)
    sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 6 6 6 6 . . 
        . . . . . 6 c 6 6 6 6 6 6 9 6 . 
...
game.onUpdateInterval(3000, function () {
    sprites.create(img`
        ...
        . . . . f f f f . . . . f f f . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy).setPosition(147, 81)
    sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 3 3 3 3 3 3 3 3 . . 
        . . . . . 3 c 3 3 3 3 3 3 d 3 . 
...
game.onUpdateInterval(4500, function () {
    sprites.create(img`
        ...
        . . . . f f f f . . . . f f f . 
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy).setPosition(145, 49)
    sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 6 6 6 6 . . 
        . . . . . 6 c 6 6 6 6 6 6 9 6 . 
